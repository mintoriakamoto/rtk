...
* add git checkout support ([be1844c](https://github.com/mintoriakamoto/rtk/commit/be1844c7c5bdcdbdad8698c7fb38f6670fdad494))
* add git checkout support ([bb01d6c](https://github.com/mintoriakamoto/rtk/commit/bb01d6c8ba6dc7dca8dfe209b04703dfef4c4264))
* add uv run support ([a5f0774](https://github.com/mintoriakamoto/rtk/commit/a5f0774d0ede5071f4d9231efc722e4ad04cded4))
* add uv run support ([5e3e54a](https://github.com/mintoriakamoto/rtk/commit/5e3e54a354ead746bdf5253d441d9d85e3454354))
* address pr suggestions ([9bd6e6f](https://github.com/mintoriakamoto/rtk/commit/9bd6e6f3929cf320193e34a2654603afa1e9fa91))
* **cargo:** route --message-format=json builds through explicit arg detection ([5ea03f3](https://github.com/mintoriakamoto/rtk/commit/5ea03f3d1bd30803a333ead8082ee716e25256fc))
* **copilot:** CLI native integration ([a9a978c](https://github.com/mintoriakamoto/rtk/commit/a9a978c10aa5ad5156ba7e324b87434b2b452ade))
* **grep:** sort content alphabetically ([307b557](https://github.com/mintoriakamoto/rtk/commit/307b5573838d24cc59191c12422ef1f216b9a087))
* **hook:** --global Copilot install + transparent rewrite via modifiedArgs ([4b0bbf2](https://github.com/mintoriakamoto/rtk/commit/4b0bbf269b34e953bf08b6d15b2ffc13cf812fb3))
* **hook:** add Cargo.lock ([531bc93](https://github.com/mintoriakamoto/rtk/commit/531bc9380cd43e10914f1449315201aff15b9153))
* **hook:** add Cargo.lock ([fa0afa5](https://github.com/mintoriakamoto/rtk/commit/fa0afa51ee9f378670e2c55ab4022976e4e4646c))
* **hook:** add pi support ([805caf7](https://github.com/mintoriakamoto/rtk/commit/805caf7d069e93370a316682b36aad59d562de2e))
* **hook:** add support for Kimi AI agent ([7624c43](https://github.com/mintoriakamoto/rtk/commit/7624c434882bf8781a0c7281b059397371341525))
* **hooks:** add Factory Droid integration ([8a8b356](https://github.com/mintoriakamoto/rtk/commit/8a8b356915c62e3a0c505fde76f8871239888e03))
* **hooks:** add Factory Droid integration ([38028b7](https://github.com/mintoriakamoto/rtk/commit/38028b7ce514e1b0f506d4ba94ea0a2d0589d924))
* **hooks:** add transparent hook support for Mistral Vibe CLI ([d480f1e](https://github.com/mintoriakamoto/rtk/commit/d480f1ec481fbd30bce16269a31d5d063bb96023))
* **hooks:** transparent pre_tool rewrite for Mistral Vibe CLI (closes [#800](https://github.com/mintoriakamoto/rtk/issues/800)) ([de1f568](https://github.com/mintoriakamoto/rtk/commit/de1f568c50ec4eeaba6b89695050fc08dc6a9d54))
* **hook:** wire Copilot into uninstall, telemetry, and discover ([84b703d](https://github.com/mintoriakamoto/rtk/commit/84b703d7d02d0fa9b25ab9a39ccc467da2eba440))
* **hook:** wire TOML filters + better tee tail hint ([31f9d43](https://github.com/mintoriakamoto/rtk/commit/31f9d43d81f90d29e89142f3306473e786e59f6c))
* **hook:** wire TOML filters into the rewrite path + reversible truncation ([73b8cb3](https://github.com/mintoriakamoto/rtk/commit/73b8cb3069297374a3de58552b9fe4aa2cda3a41))
* **mvn:** cap failing-class blocks and Failures summary entries ([be6c812](https://github.com/mintoriakamoto/rtk/commit/be6c812416610f91025df2b49735c61c5f075fb3))
* **mvn:** filter mvn -q quiet-mode output ([97dbf98](https://github.com/mintoriakamoto/rtk/commit/97dbf98cc6cb6ee7d5a3ba4d29450924142df4ee))
* **oc:** add Openshift CLI support with shared k8s filtering ([39cbb96](https://github.com/mintoriakamoto/rtk/commit/39cbb968970d705d2080fc4062397f5b8650b595))
* **oc:** add Openshift CLI support with shared k8s filtering ([c7f493b](https://github.com/mintoriakamoto/rtk/commit/c7f493b0cd0fbe9ed1d2da8ea66f86f2ca26cd01))
* **php:** consolidated PHP tooling (php, artisan, phpunit, phpstan, pest, paratest, ecs, pint) ([1052c1c](https://github.com/mintoriakamoto/rtk/commit/1052c1c7027d5a720e3a416a5afb7c1c4c3f5bfc))
* **php:** consolidated PHP tooling (php, artisan, phpunit, phpstan, pest, paratest, ecs, pint) ([30fe7a4](https://github.com/mintoriakamoto/rtk/commit/30fe7a4090e424c6fac8d72c9dcd7d5802f1905a))
* **pipe:** expose PHP tool filters as stdin pipe filters ([214a79a](https://github.com/mintoriakamoto/rtk/commit/214a79a9ff0a5991ae7dc86badb72f3275333498))
* **portal:** rtk portal login/sync — upload savings aggregates for metering ([8583b70](https://github.com/mintoriakamoto/rtk/commit/8583b704ebaf6363d244c507d78553e23e10ea48))
* **portal:** rtk portal login/sync — upload savings aggregates for metering ([fd6c85f](https://github.com/mintoriakamoto/rtk/commit/fd6c85fadecafc94f6cd4ad5185e628fb9554ac0))
* prefer short args and cleanup comments ([53b5e79](https://github.com/mintoriakamoto/rtk/commit/53b5e79561fdf98f09db0b5b2006ec838fcd06f5))
* **pulumi:** add CLI filters for preview/up/destroy/refresh/stack ([ced70c6](https://github.com/mintoriakamoto/rtk/commit/ced70c6f0dcccd85365dcc78ca58f6b330d799e8))
* **rewrite:** rewrite each line of multi-line Bash blocks ([fc8054e](https://github.com/mintoriakamoto/rtk/commit/fc8054eb0b357d32cb0457094d142de52c3db0e7)), closes [#1243](https://github.com/mintoriakamoto/rtk/issues/1243)
* **rewrite:** rewrite multiline blocks ([3044911](https://github.com/mintoriakamoto/rtk/commit/3044911b50bc59777d0dedbcd17eb513305c8de5))
* **sbt:** add SBT (Scala Build Tool) support ([4f86523](https://github.com/mintoriakamoto/rtk/commit/4f865233db81d9075d237bc8fea82f15013baedc))
* **sbt:** add SBT (Scala Build Tool) support ([9b8c0b5](https://github.com/mintoriakamoto/rtk/commit/9b8c0b594de09b55c5ed99c86befbe9fbfa90aff))
* **sbt:** capture failure details, add integration test routing, handle Mockito/ScalaMock ([d078578](https://github.com/mintoriakamoto/rtk/commit/d07857886f63d286ce144de2cef549571ee4ad98))
* **sbt:** support -batch flag and scoped task notation (Test/compile) ([189409b](https://github.com/mintoriakamoto/rtk/commit/189409bd308aec6b31c81cc1b092247cb1216dcd))
* **trust:** gate custom filters (project + user-global) + init opt-in flags ([1130a7c](https://github.com/mintoriakamoto/rtk/commit/1130a7cafd4df9ca111525dc704a68898594d4ae))
* **trust:** rtk trust uses the same opt-in prompt as init ([e0a83ac](https://github.com/mintoriakamoto/rtk/commit/e0a83ac824a44450b014838e7bbcb2cfcb872c8f))


### Bug Fixes

* **analytics:** floor prefix slices to char boundary instead of full-string fallback ([c9468ee](https://github.com/mintoriakamoto/rtk/commit/c9468ee178083aeecbaafb2afdd00887f2eca193))
* **analytics:** truncate display strings on UTF-8 char boundaries ([e200764](https://github.com/mintoriakamoto/rtk/commit/e20076433e0a8e19801ed5c39e03ea25a98a9c1c))
* **analytics:** truncate display strings on UTF-8 char boundaries ([47b22e0](https://github.com/mintoriakamoto/rtk/commit/47b22e03a4759972c11032e642710a473b9706ce)), closes [#2787](https://github.com/mintoriakamoto/rtk/issues/2787)
* **aws:** guard the s3 ls and s3 sync/cp text emits ([25a095e](https://github.com/mintoriakamoto/rtk/commit/25a095e90d7f8320d80577177f7623b13fa1bbad))
* **aws:** preserve values in JSON output for unsupported subcommands ([9574007](https://github.com/mintoriakamoto/rtk/commit/9574007f77fa7051e93d10c512809e60ed61ac57))
* **aws:** preserve values in JSON output for unsupported subcommands ([ad2bfd3](https://github.com/mintoriakamoto/rtk/commit/ad2bfd3225587ab2487f122868e4ea6e5facea7d))
* **bench:** compare wget stdout mode to stdout mode ([730fbcf](https://github.com/mintoriakamoto/rtk/commit/730fbcf36cce76217ea860071ce477969391fe82))
* **benchmark:** use deterministic curl and wget responses ([3304d90](https://github.com/mintoriakamoto/rtk/commit/3304d903a6e3eb982ba60a27fb65a85c86f5090d))
* **benchmark:** use deterministic curl and wget responses ([6c57836](https://github.com/mintoriakamoto/rtk/commit/6c57836bfbfc09bddbafeee171dabe737d009c9b))
* **benchmark:** use stable indexed MockHTTP responses ([8dd5a34](https://github.com/mintoriakamoto/rtk/commit/8dd5a3476d2a81f1612fbc0be9cac07d09b19e89))
* **bench:** pin network benchmark payloads so raw vs rtk compare the same bytes ([8efee2a](https://github.com/mintoriakamoto/rtk/commit/8efee2aca0540d76909f83fbe4b1e6aa1209e582))
* **cargo:** cap json build diagnostics like the human-text path ([5ee9c82](https://github.com/mintoriakamoto/rtk/commit/5ee9c825cf18e4d65f1c1cb774bdd83ac089d9ac))
* **cargo:** give the json batch filter the exit code ([a3e65e9](https://github.com/mintoriakamoto/rtk/commit/a3e65e99e9eb7e1151b726b836b372ab5d857893))
* **cargo:** honor last --message-format when the flag is repeated ([25d6a09](https://github.com/mintoriakamoto/rtk/commit/25d6a09c01a6d906da49ba8c51f61ce4ee2d7785))
* **cargo:** keep "No issues found" wording for clean clippy json runs ([1f74614](https://github.com/mintoriakamoto/rtk/commit/1f74614ea8c148fbfe6886b445519e58d32af3ec))
* **cargo:** label check output as "check" instead of "build" ([90b4f5f](https://github.com/mintoriakamoto/rtk/commit/90b4f5f40fc561bad3616c3aefc3cb21c22c0088))
* **cargo:** match the human path when skipping the json warning summary ([59ed885](https://github.com/mintoriakamoto/rtk/commit/59ed885752a9ba3e77ee2dd02a75000cc6c1aba9))
* **cargo:** restore failure check before trusting reused build filter ([e4bfe35](https://github.com/mintoriakamoto/rtk/commit/e4bfe3593c04a497770f6f6492599ac77b3c948d))
* **cargo:** skip "N warnings generated" record in json diagnostics ([9ae0872](https://github.com/mintoriakamoto/rtk/commit/9ae0872aeebc777f7850d5b4f16b0943fe7bc765))
* **cargo:** strip ansi from json rendered diagnostics ([b47653a](https://github.com/mintoriakamoto/rtk/commit/b47653a9ec2d5a3fcc1df28b36d23156bb92112a))
* **cargo:** surface --message-format=json build errors instead of "compiled" ([a4b7f74](https://github.com/mintoriakamoto/rtk/commit/a4b7f7422e5a330c88ad33b9cfda86866a5c8c2c))
* **cargo:** surface --message-format=json build errors instead of "compiled" ([99307b2](https://github.com/mintoriakamoto/rtk/commit/99307b2f51d205c381e64f38331c46403e858930)), closes [#2419](https://github.com/mintoriakamoto/rtk/issues/2419)
* **cargo:** surface --message-format=json clippy errors ([58abbf2](https://github.com/mintoriakamoto/rtk/commit/58abbf253c0fcca15ccd3d8f7441898fe72b3399))
* **cargo:** surface --message-format=json install errors ([7fb9459](https://github.com/mintoriakamoto/rtk/commit/7fb9459fc6fe7b4d69ad8abfeb815427b615c368))
* **cargo:** surface --message-format=json test compile errors ([f9b720c](https://github.com/mintoriakamoto/rtk/commit/f9b720c8f7e7c972739b84679d451e50ba0b6124))
* **cargo:** tee-hint dropped json diagnostics beyond the cap ([cf1caf9](https://github.com/mintoriakamoto/rtk/commit/cf1caf93b8cdfd2db974ff3cb1b3859cbb955257))
* **cargo:** tighten json warning-summary skip to ends_with ([6c9a60d](https://github.com/mintoriakamoto/rtk/commit/6c9a60d83e2911f7367642b2e8242d11035118e7))
* **ccusage:** accept `period` key from current ccusage ([d823aaf](https://github.com/mintoriakamoto/rtk/commit/d823aaf76721d9b0a02cd428ea714980ef80df2c))
* **ccusage:** accept `period` key from current ccusage ([d0a77cd](https://github.com/mintoriakamoto/rtk/commit/d0a77cdb4844027d37af9c7a6d853ad923cac37a))
* **cicd:** git app token for next release ([48d45d3](https://github.com/mintoriakamoto/rtk/commit/48d45d366627d405397d974808392f7294266e84))
* **cicd:** git app token for next release ([cdfb14c](https://github.com/mintoriakamoto/rtk/commit/cdfb14c0f036bc5c6d36a9dc794e536b4f8eca5f))
* **cicd:** MIT to Apache 2.0 ([5a149a7](https://github.com/mintoriakamoto/rtk/commit/5a149a7fdb92afe758a0c28d805873ce61d8259f))
* **cicd:** MIT to Apache 2.0 ([e132896](https://github.com/mintoriakamoto/rtk/commit/e132896d3f3b588813f59790a5c2f7d35e40cb78))
* **cicd:** next release pr target fork compatibel ([6e34bba](https://github.com/mintoriakamoto/rtk/commit/6e34bbaa989487b671952c07105706f006841f23))
* **cicd:** next release pr target fork compatible ([ce30f37](https://github.com/mintoriakamoto/rtk/commit/ce30f378e3b6797361a73166adcb1238a7c054ad))
* **ci:** exempt release-please PRs from the wrong-base-branch check ([1da6a2e](https://github.com/mintoriakamoto/rtk/commit/1da6a2e397cbe86a1a900abdab7533941f47f185))
* **ci:** exempt release-please PRs from the wrong-base-branch check ([47b56bb](https://github.com/mintoriakamoto/rtk/commit/47b56bb4802bd0f6a7a856c99eaae30c52f32670))
* **ci:** make Next Release PR workflow work without the GitHub App ([3c95597](https://github.com/mintoriakamoto/rtk/commit/3c955978a31e9fc7cdea1b5ee55a9d3461bea580))
* **ci:** make Next Release PR workflow work without the GitHub App ([c122f8c](https://github.com/mintoriakamoto/rtk/commit/c122f8c4e3bf94533760f2f6f7a2c5140eb4c215))
* **ci:** pin fixture line endings, harden CRLF tests ([be28a51](https://github.com/mintoriakamoto/rtk/commit/be28a511797fb5214ff0784f57f491d2b7dd0e71))
* **ci:** secrets context in step-level if broke all CD runs — gate via job env ([9808118](https://github.com/mintoriakamoto/rtk/commit/98081185e0d24dece93f99b8689d7a7f4efffecf))
* **ci:** secrets context is invalid in step-level if — gate app-token steps via job env ([6792ae2](https://github.com/mintoriakamoto/rtk/commit/6792ae2c0fe24128b80e8d15e97ca08f788b6ec6))
* **copilot-cli:** use user-level instruction for -g ([e3ad973](https://github.com/mintoriakamoto/rtk/commit/e3ad9736177116b637da17faaf38f70312ab6148))
* **copilot:** add missing 'get' to kubectl example in init template ([f9d8c77](https://github.com/mintoriakamoto/rtk/commit/f9d8c775b1e7f94f449c400f4130410170e590ad))
* **copilot:** add missing 'get' to kubectl example in init template ([5a0a86d](https://github.com/mintoriakamoto/rtk/commit/5a0a86dbeab67905ee07e1ef377522b5100cabcc))
* **copilot:** remove unnecessary test ([b49568f](https://github.com/mintoriakamoto/rtk/commit/b49568ff730608d6ae815a11ed2ab230aecd5657))
* **copilot:** support IDE terminal hooks ([1d6798d](https://github.com/mintoriakamoto/rtk/commit/1d6798de8aee0940b490719153e7554845f8f43c))
* **copilot:** support IDE terminal hooks ([d0f004f](https://github.com/mintoriakamoto/rtk/commit/d0f004f61da16eaba12f69c4542ac6d50754d63d))
* **core:** never-worse output guard ([af81b08](https://github.com/mintoriakamoto/rtk/commit/af81b08175af063c8b631979959d80c9007d089f))
* **core:** never-worse output guard so RTK never exceeds the raw command ([861a46d](https://github.com/mintoriakamoto/rtk/commit/861a46dee57f50216862ac83b0ee57974f383203))
* **curl:** passthrough binary downloads to prevent UTF-8 corruption ([a2a63e1](https://github.com/mintoriakamoto/rtk/commit/a2a63e15f4d34f5de35eb7dc32eadb0b02f77327)), closes [#1087](https://github.com/mintoriakamoto/rtk/issues/1087)
* **curl:** passthrough binary downloads to prevent UTF-8 corruption ([#1087](https://github.com/mintoriakamoto/rtk/issues/1087)) ([35273c2](https://github.com/mintoriakamoto/rtk/commit/35273c2dc1c94dd93ba97555e72b4e46928574b6))
* detect absolute rtk path in Claude hook settings ([5d32d07](https://github.com/mintoriakamoto/rtk/commit/5d32d0736f686b69d1e8b9dc45c007d4eb77a0a2))
* detect absolute rtk path in Claude hook settings ([48b883f](https://github.com/mintoriakamoto/rtk/commit/48b883f49eacc5c1e9301a5e9fb6916053f632a3))
* **diff:** report modified-only diffs and follow diff exit convention ([3a73bcd](https://github.com/mintoriakamoto/rtk/commit/3a73bcdffc553c0b1b81ea423b98b221468a7289))
* **diff:** report modified-only diffs and follow diff exit convention ([c126d45](https://github.com/mintoriakamoto/rtk/commit/c126d4594b4af1c59b8163178923207d4e9b6de4)), closes [#2364](https://github.com/mintoriakamoto/rtk/issues/2364)
* **docker:** make the agent's command authoritative for the guard baseline ([b52db52](https://github.com/mintoriakamoto/rtk/commit/b52db52da065f65f9838e7fd12c496b7d28d06e8))
* **docker:** report 0 containers/images instead of empty output ([3d4189c](https://github.com/mintoriakamoto/rtk/commit/3d4189cc6304a8eefc7ab94388b268054b94a634))
* **docs:** replace remaining MIT license references with Apache 2.0 ([4c099e4](https://github.com/mintoriakamoto/rtk/commit/4c099e4b5f64793ea95e14ac3fef96125f3a6fff))
* **docs:** replace remaining MIT license references with Apache 2.0 ([9bbc7bb](https://github.com/mintoriakamoto/rtk/commit/9bbc7bb79e702ada58f5cfe2499d441715aa6bbd))
* **dotnet:** keep raw fallback when parsed failures incomplete ([5e7eab5](https://github.com/mintoriakamoto/rtk/commit/5e7eab5846cfe2de1f0d0c2a7d6c38c8de6c65e5))
* **dotnet:** stop duplicating failures on failing test runs ([2d9dc1a](https://github.com/mintoriakamoto/rtk/commit/2d9dc1ab9e0d25bf7fa6b8696f8909a561dd267f)), closes [#2501](https://github.com/mintoriakamoto/rtk/issues/2501)
* **dotnet:** stop duplicating failures on failing test runs ([#2501](https://github.com/mintoriakamoto/rtk/issues/2501)) ([6946bf9](https://github.com/mintoriakamoto/rtk/commit/6946bf9562a26c7248d64d76564619a7d8dd4dd6))
* **env:** clean up feature from secrets rewrite ([223dda2](https://github.com/mintoriakamoto/rtk/commit/223dda2996c061e93605d996a14d454a56198ec4))
* **filter:** address review findings in the TOML filter path ([315a943](https://github.com/mintoriakamoto/rtk/commit/315a94398ec06e70e7cebd3647d5a00a0bd76edc))
* **filters:** remove max_lines cap from helm filter that truncates template output ([63a76de](https://github.com/mintoriakamoto/rtk/commit/63a76dedff245173a8e9240e09c741552f318de3))
* fmt ([bcee6cc](https://github.com/mintoriakamoto/rtk/commit/bcee6cc2ea97a77201772112eee7125ce24e2be4))
* **gain:** note untrusted custom filters so they can be re-trusted ([a4872d9](https://github.com/mintoriakamoto/rtk/commit/a4872d9bbf1e5002381d6c7973803b7ae2010077))
* **gh,glab:** don't pre-reject view/checks/run subcommands missing the id ([3c8d29a](https://github.com/mintoriakamoto/rtk/commit/3c8d29a57d6f1e3e1e50d0535540ea6fdff1d393))
* **gh,glab:** don't pre-reject view/checks/run subcommands missing the id ([e1bb17f](https://github.com/mintoriakamoto/rtk/commit/e1bb17f85d387816621a6e77eca44f94458c4e81))
* **gh:** show fallback note when PR/issue body is filtered to empty ([4128572](https://github.com/mintoriakamoto/rtk/commit/41285725e446706204943d826d89e19608df0c03)), closes [#235](https://github.com/mintoriakamoto/rtk/issues/235)
* **git:** compact git stash show instead of forcing -p ([1b38eec](https://github.com/mintoriakamoto/rtk/commit/1b38eece9b08ac00d4cd49a7354413485501afcc))
* **git:** compact git stash show instead of forcing -p ([add35e0](https://github.com/mintoriakamoto/rtk/commit/add35e0928540b44b7bdaa820a3620464e11fbf8))
* **git:** compress git stash show summary line ([0ac5f5c](https://github.com/mintoriakamoto/rtk/commit/0ac5f5c3118a5e244c58d2dc24d8b9cb0a954b21))
* **git:** drop -uall from compact status so output never exceeds raw ([06476d1](https://github.com/mintoriakamoto/rtk/commit/06476d17cbd49a8a6d06beae9b4a9f0cb9f96f00))
* **git:** drop -uall from compact status so output never exceeds raw ([7753e48](https://github.com/mintoriakamoto/rtk/commit/7753e487b3595886d39492be9b43ecad26c826ca))
* **git:** fix panic on multibyte chars in commit output ([4f4a6a0](https://github.com/mintoriakamoto/rtk/commit/4f4a6a02ae299495848b644e087acc9da51d4f8c))
* **git:** propagate exit code on git status failure in compact path ([d86f007](https://github.com/mintoriakamoto/rtk/commit/d86f0073ec294d75a705c49c95061bd2c09e2b18))
* **git:** propagate exit code on git status failure in compact path ([756c2a4](https://github.com/mintoriakamoto/rtk/commit/756c2a4ce84424a17965810392b21c7320b12678))
* **git:** propagate exit code on git worktree list failure ([9a52647](https://github.com/mintoriakamoto/rtk/commit/9a52647f6529120723a04e5323f2b38be5b22655))
* **git:** propagate exit code on git worktree list failure ([ebaaf8d](https://github.com/mintoriakamoto/rtk/commit/ebaaf8db586a1a31904a122cd815242e183bd536))
* **git:** propagate exit code when commit fails instead of reporting ok ([2927248](https://github.com/mintoriakamoto/rtk/commit/29272484de23b1cd1144d97ca6c334da1ee81a61))
* **git:** propagate exit code when commit fails instead of reporting ok ([e36dd8c](https://github.com/mintoriakamoto/rtk/commit/e36dd8cbe7cf5f37b6c67115d6d53eccc90c94ab)), closes [#2494](https://github.com/mintoriakamoto/rtk/issues/2494)
* **go:** respect build failure exit status ([6873764](https://github.com/mintoriakamoto/rtk/commit/68737644b761460451e93447b7f06bd8259b2161))
* **go:** respect build failure exit status ([f69ad6e](https://github.com/mintoriakamoto/rtk/commit/f69ad6ed6f3f17b66e203613e3015fee517783f9))
* **grep:** code and test cleanup ([7d6255f](https://github.com/mintoriakamoto/rtk/commit/7d6255f0e04b9c669f13c0f4cb281ca1029816eb))
* **grep:** command token duplication in output withsame value filename or positional arg ([57e9350](https://github.com/mintoriakamoto/rtk/commit/57e935094b0c4b93702f94437f21bbd0248ecf49))
* **grep:** command token duplication in output withsame value filename or positional arg ([89ae19b](https://github.com/mintoriakamoto/rtk/commit/89ae19b1cff8251e1b8a0ed590510bef2688bb7d))
* **grep:** correctly handle all flag shapes and never exceed raw output ([ee9e2f8](https://github.com/mintoriakamoto/rtk/commit/ee9e2f8a2ad9618495dad0f10763f4891ae47be8))
* **grep:** correctly handle all flag shapes and never exceed raw output ([0adfae6](https://github.com/mintoriakamoto/rtk/commit/0adfae6cf61a90a98a007a6ef4a8745ab6f42a31))
* **grep:** fix value-taking flags, -rN clusters, multi-path, and -e patterns ([c40b3ef](https://github.com/mintoriakamoto/rtk/commit/c40b3ef9dbefeecff0408b0fd459b8376aeabdc1))
* **grep:** handle value-taking flags in tail position of short clusters ([acb3a2d](https://github.com/mintoriakamoto/rtk/commit/acb3a2d5cd0a503883a420acebedb0043c4165a7))
* **grep:** left-to-right cluster scan, long value flags, format passthrough ([b7d93b5](https://github.com/mintoriakamoto/rtk/commit/b7d93b509e67eee46de3bb518e7ca71429188a4b))
* **grep:** match real grep output and read piped stdin ([37ee6cf](https://github.com/mintoriakamoto/rtk/commit/37ee6cf6fa7ecb1b511aafd0b111b68ba1d5c945))
* **grep:** NUL-separate file from line:content per review ([0e3a6f4](https://github.com/mintoriakamoto/rtk/commit/0e3a6f48305c1302443cbe5206e5b5f7cffb671a))
* **grep:** only insert -- separator when context flags are active ([34a0f0e](https://github.com/mintoriakamoto/rtk/commit/34a0f0e5c00e8f3e98ac8d430b9e1681bdf9b680))
* **grep:** parse single-file output containing colons ([be226d4](https://github.com/mintoriakamoto/rtk/commit/be226d4f1dcdcc0df29ad6f9968be5ab37ed5c19))
* **grep:** parse single-file output containing colons ([#1554](https://github.com/mintoriakamoto/rtk/issues/1554)) ([8e04ac4](https://github.com/mintoriakamoto/rtk/commit/8e04ac4212ea2a7ec680b95a31e17b4c942e6209))
* **grep:** preserve -- separator between non-adjacent match blocks ([6871e55](https://github.com/mintoriakamoto/rtk/commit/6871e55358acb43a2aa6390565be3b45d64e08b2))
* **grep:** preserve -- separator between non-adjacent match blocks ([cae9b71](https://github.com/mintoriakamoto/rtk/commit/cae9b710d4aca0f588ea1b1d5b1341b414c3f2c8)), closes [#2795](https://github.com/mintoriakamoto/rtk/issues/2795)
* **grep:** restore strip_r as explicit testable helper + pre-existing clippy fix ([8d29f75](https://github.com/mintoriakamoto/rtk/commit/8d29f75833c9afe5eebdb5d6d1ce1743503421e7))
* **grep:** run the invoked engine instead of substituting rg for grep ([eafadce](https://github.com/mintoriakamoto/rtk/commit/eafadcee0042411ab9d28339d865a626567a72b0))
* **grep:** stabilize argument parsing ([84616d1](https://github.com/mintoriakamoto/rtk/commit/84616d131d77aa853b386b4fdb4a45b52b0c78aa))
* **grep:** stabilize argument parsing — trailing_var_arg, -v invert-match, --version passthrough, safe rg invocation ([d8c550e](https://github.com/mintoriakamoto/rtk/commit/d8c550eefba41e112bd174d58844a803db6e432f))
* **grep:** surface error on exit code &gt;= 2 instead of false "0 matches" ([d727db3](https://github.com/mintoriakamoto/rtk/commit/d727db3fa1f5b90d94cd8e1b893b6b10418b42bd)), closes [#2461](https://github.com/mintoriakamoto/rtk/issues/2461)
* **grep:** surface the engine error and exit code, add nothing ([05f3c54](https://github.com/mintoriakamoto/rtk/commit/05f3c54886e6d39476b1e65275c599fe4dc470a3))
* **grep:** use portable --null in system grep fallback (BSD/macOS) ([abe7d42](https://github.com/mintoriakamoto/rtk/commit/abe7d4210e0fe5c0b9322ec5210c6a6aadaa3db5))
* handle GNU `--format=long` and `--format=verbose` long args ([8fcc0dc](https://github.com/mintoriakamoto/rtk/commit/8fcc0dc56c0bbcdf0508bbf72897085348884fd5))
* honor explicit -n N limit for git log on merge commits ([26c8890](https://github.com/mintoriakamoto/rtk/commit/26c88907d945ec81a25fe631a39dee3830faa0ec))
* **hook:** collapse bash line continuations before matching ([#1564](https://github.com/mintoriakamoto/rtk/issues/1564)) ([2543be5](https://github.com/mintoriakamoto/rtk/commit/2543be59126f5b6825b48570a5b5fb99d0112dab))
* **hook:** collapse bash line continuations before matching ([#1572](https://github.com/mintoriakamoto/rtk/issues/1572)) ([39f044e](https://github.com/mintoriakamoto/rtk/commit/39f044efd87e5de74c60b090de69882297918dd9)), closes [#1564](https://github.com/mintoriakamoto/rtk/issues/1564)
* **hook:** default Copilot CLI rewrite to 'ask' to preserve permission prompts ([69c10b6](https://github.com/mintoriakamoto/rtk/commit/69c10b65887527d5cf95e2c48f8c1b58a1fd3077))
* **hook:** detect Copilot CLI shell tool on Windows ([7da2674](https://github.com/mintoriakamoto/rtk/commit/7da2674073394194754a228d346189a74869e6ba))
* **hook:** detect Copilot CLI shell tool on Windows ([10ca886](https://github.com/mintoriakamoto/rtk/commit/10ca886c92f8423f60c3fcbfd7a75e26f396845f)), closes [#3178](https://github.com/mintoriakamoto/rtk/issues/3178)
* **hook:** emit Copilot CLI-compatible hook config + strip BOM on Windows ([8fb29e2](https://github.com/mintoriakamoto/rtk/commit/8fb29e2f75a34d9430be74975cccd30213e619aa))
* **hook:** handle AskRewrite in Cursor hook when no rules configured ([ff0b9ac](https://github.com/mintoriakamoto/rtk/commit/ff0b9ac28cc1f5215760f123cefff23c62c0821a)), closes [#2372](https://github.com/mintoriakamoto/rtk/issues/2372)
* **hook:** include ask rules in cursor_has_explicit_rules check ([3362325](https://github.com/mintoriakamoto/rtk/commit/33623258b8354601bdfd83d1ff6cdb7a2b316fc8))
* **hook:** kimi init writes AGENTS.md instead of dead .kimirules ([8fe4a40](https://github.com/mintoriakamoto/rtk/commit/8fe4a406125a454450e6ffdbcf743c1a20a12418))
* **hook:** omit permissionDecision so Copilot prompts for the rewritten command ([db483e6](https://github.com/mintoriakamoto/rtk/commit/db483e6c58eccc917864a95282746f9fe52af23c))
* **hook:** preserve Copilot CLI toolArgs metadata when rewriting command ([6c5e440](https://github.com/mintoriakamoto/rtk/commit/6c5e440d83b30168c61e4c4b0c79847414a7c509))
* **hook:** rewrite pytest under uv run ([c8722bd](https://github.com/mintoriakamoto/rtk/commit/c8722bd55e4441ac377b9c141c5f445e62fe9ecc))
* **hooks:** copilot self heal dual hooks (drop camelCase entry) ([9936b2b](https://github.com/mintoriakamoto/rtk/commit/9936b2b9ce560283d7be21fdfad027cb537be69c))
* **hooks:** distinguish explicit ask from default in AskRewrite ([0df6929](https://github.com/mintoriakamoto/rtk/commit/0df69293ac352f56e507ab9e72d7396abbccc078))
* **hooks:** don't force-allow Droid rewrites ([9dd8211](https://github.com/mintoriakamoto/rtk/commit/9dd82113adeccdb9597a1f871922f92335643a7b))
* **hooks:** drop redundant camelCase preToolUse entry from Copilot hook config ([b754b85](https://github.com/mintoriakamoto/rtk/commit/b754b850098fcbcf89c3d31be025943d69e5dfca))
* **hook:** semgrep marker + regression tests for Copilot hook isolation ([557e57c](https://github.com/mintoriakamoto/rtk/commit/557e57c9f9fe90b090d7bb62024d8bcddd81b732))
* **hooks:** emit permissionDecision allow for simple Copilot CLI rewrites ([23d1e89](https://github.com/mintoriakamoto/rtk/commit/23d1e899ce89bef54dfa7f3b6f66374c24f311e7))
* **hooks:** emit permissionDecision allow for simple Copilot CLI rewrites ([84aa4d6](https://github.com/mintoriakamoto/rtk/commit/84aa4d6f71bea0e39e234a0869dd82ee075c7286)), closes [#3037](https://github.com/mintoriakamoto/rtk/issues/3037)
* **hooks:** heal only rtk's own legacy camelCase entry, keep user config ([db31da9](https://github.com/mintoriakamoto/rtk/commit/db31da9af4d46ece27f996f350ecbaf6b724e208))
* **hooks:** install Droid hook into canonical hooks.json ([da36ba3](https://github.com/mintoriakamoto/rtk/commit/da36ba3935a4c476edaedd3e447c9c58e1bc0f09))
* **hooks:** make Droid verdicts deny-only from explicit lists in all scopes ([3d40742](https://github.com/mintoriakamoto/rtk/commit/3d407426b5ca63ca7e6bd0f31a572e9b0342b05b))
* **hooks:** recognize VS Code Copilot Chat's run_in_terminal tool name ([1ebc271](https://github.com/mintoriakamoto/rtk/commit/1ebc2710d1d024420d2460693d020bbe50911564))
* **hooks:** self-heal stale dual-schema Copilot hook config ([d1f7139](https://github.com/mintoriakamoto/rtk/commit/d1f71398fde6e071c416cb2b6dbe9665b2bfb488))
* **hooks:** source Droid verdicts from Droid's own permission lists ([70ed82a](https://github.com/mintoriakamoto/rtk/commit/70ed82a7b7af743369daba99a9450cdbf5888049))
* **hooks:** stop Copilot from ever asserting a permissionDecision on AskRewrite ([0fcd6ad](https://github.com/mintoriakamoto/rtk/commit/0fcd6ad670597451194e97777d065009675f57a1))
* **hooks:** stop Copilot from silently deciding permission on unconfigured commands ([8722378](https://github.com/mintoriakamoto/rtk/commit/8722378a22d197ad8cc2e86d40b468cc8fb8571d))
* **hook:** treat uv run as a transparent prefix ([34441dd](https://github.com/mintoriakamoto/rtk/commit/34441dd4648d5f73bf40988de0c9f2c839b3e988))
* **hook:** use ask action in audit log for AskRewrite verdict ([36dd8f2](https://github.com/mintoriakamoto/rtk/commit/36dd8f24792b4d36af59a114bdce01d4f5a8cbf1))
* **hook:** use ask permission for AskRewrite in Cursor hook ([a0c16ef](https://github.com/mintoriakamoto/rtk/commit/a0c16ef0bcf9d7f8403c098c5f26bb4f8dcd98f6))
* **hook:** use maintainer regex suggestion for line continuation ([42ac86c](https://github.com/mintoriakamoto/rtk/commit/42ac86ce2f5bedb011f84532c2112cd5093500ab))
* **init:** honor RTK_TELEMETRY_DISABLED in consent prompt ([#1307](https://github.com/mintoriakamoto/rtk/issues/1307)) ([66e09cb](https://github.com/mintoriakamoto/rtk/commit/66e09cbefe02bf82b159a44278250e45e506810b))
* **init:** honor RTK_TELEMETRY_DISABLED in consent prompt ([#1307](https://github.com/mintoriakamoto/rtk/issues/1307)) ([debac0f](https://github.com/mintoriakamoto/rtk/commit/debac0f4c62f875b25a8afa33e57dc4283fd24d7))
* **init:** preserve settings.json symlink during atomic write ([508192d](https://github.com/mintoriakamoto/rtk/commit/508192dbdcc6a1a753afbd0c87f7255886fad2ea)), closes [#653](https://github.com/mintoriakamoto/rtk/issues/653)
* **init:** respect CLAUDE_CONFIG_DIR for global paths ([05de9d3](https://github.com/mintoriakamoto/rtk/commit/05de9d366aff627f044e0a40daf5fcbcf277ea30)), closes [#633](https://github.com/mintoriakamoto/rtk/issues/633)
* **init:** use fs::canonicalize for symlink resolution ([f1474b4](https://github.com/mintoriakamoto/rtk/commit/f1474b4c12ec3a3d9f8e46b14bfd8b2d70119137))
* **ls:** preserve permission info as octal when -l/-la is passed ([6c4dfc7](https://github.com/mintoriakamoto/rtk/commit/6c4dfc727af0423318bf21a66d53474089d25bf4)), closes [#1672](https://github.com/mintoriakamoto/rtk/issues/1672)
* **ls:** preserve permission info as octal when -l/-la is passed ([#1675](https://github.com/mintoriakamoto/rtk/issues/1675)) ([6e76f91](https://github.com/mintoriakamoto/rtk/commit/6e76f911d6dfffb47fea99417ecde89df36913e4))
* minor print_manual_instructions regression ([6785a6c](https://github.com/mintoriakamoto/rtk/commit/6785a6c7695d7273e722214a295249a84819b6f0))
* **mvn:** keep multi-module Reactor Summary rows ([4609102](https://github.com/mintoriakamoto/rtk/commit/460910267b8a8876f4459ee93cbef074a61c39b6))
* **mvn:** match Surefire 3.x close lines, preserve failure stack trail ([cc152cd](https://github.com/mintoriakamoto/rtk/commit/cc152cd2ac9bfd5085b1b178a78088c11a37b0ae))
* **mvn:** preserve compile-error continuation in filter_surefire ([97bd2a7](https://github.com/mintoriakamoto/rtk/commit/97bd2a7787c459e2df396bb3d28b9660b35c5ec6))
* **mvn:** re-arm failure trail on per-test sublines ([1050cfe](https://github.com/mintoriakamoto/rtk/commit/1050cfeadcc3fd2b34df3401c6ec3aa09f0cd199))
* **mvn:** strip post-failure help boilerplate in non-quiet mode ([df76528](https://github.com/mintoriakamoto/rtk/commit/df76528dd36dba4a58163a4827d34fbb9e7c17ca))
* **openclaw:** handle exit code 3 from rtk rewrite ([487a2e7](https://github.com/mintoriakamoto/rtk/commit/487a2e7b2c381071e61062e5dfff8d2e790c54c8)), closes [#2202](https://github.com/mintoriakamoto/rtk/issues/2202)
* **openclaw:** no execSync to avoid async dangerous cmds ([f525cee](https://github.com/mintoriakamoto/rtk/commit/f525ceecf4dbaa522d70b83ca36cac5992684a92))
* **openclaw:** no execSync to avoid async dangerous cmds ([1bb17f4](https://github.com/mintoriakamoto/rtk/commit/1bb17f4fd18ef9470ba5a0c1341a35b26819da39))
* **parser:** use byte offsets instead of char indices in extract_json_object ([32dda24](https://github.com/mintoriakamoto/rtk/commit/32dda24e5b71c04d1aabe36f299e4b6d786a5421))
* **parser:** use byte offsets instead of char indices in extract_json_object ([27f9739](https://github.com/mintoriakamoto/rtk/commit/27f9739b29e5e42bbe927cddf61bbbc03f1e53d9)), closes [#2509](https://github.com/mintoriakamoto/rtk/issues/2509)
* **permissions:** &gt;&file redirect no allow + scope Gemini/Cursor config ([e16aa26](https://github.com/mintoriakamoto/rtk/commit/e16aa26162a95bd99c954c0236b5353ffe89db00))
* **permissions:** &gt;&file redirect no allow + scope Gemini/Cursor config ([ce36297](https://github.com/mintoriakamoto/rtk/commit/ce362970e5752bacfd3a356c7fa122fea94ff0b2))
* **permissions:** add test for cursor and gemini settings perm ([1ccf6e3](https://github.com/mintoriakamoto/rtk/commit/1ccf6e3da72b6c2feff43bbc4d9fc3ed2e4cd083))
* **permissions:** add test for cursor and gemini settings perm ([f181184](https://github.com/mintoriakamoto/rtk/commit/f181184b4017d71aa7f557148a2d7f1b872ab6d2))
* **permissions:** cursor and gemini use correct permissions settings file ([a4bb55e](https://github.com/mintoriakamoto/rtk/commit/a4bb55efa9be1b0bf69ccc2cff9ddcbf2af7a48d))
* **permissions:** cursor and gemini use correct permissions settings file ([6ab149b](https://github.com/mintoriakamoto/rtk/commit/6ab149ba3e41bb41b99794ef55d384c9be96b91b))
* **permissions:** never auto-allow not evaluable + defer to the agent ([952245d](https://github.com/mintoriakamoto/rtk/commit/952245d39d099ed9a804dbba21bb0486f6aede16))
* **permissions:** never auto-allow not evaluable + defer to the agent ([cdcdb68](https://github.com/mintoriakamoto/rtk/commit/cdcdb6863a3df709603dbed0a6205bf16e4e635f))
* **permissions:** never auto-allow not evaluable cmds, defer to hosts ([e1bc0bd](https://github.com/mintoriakamoto/rtk/commit/e1bc0bd9d0e52d98323714a3b163c359d6a240d2))
* **permissions:** project-first config lookup for Gemini/Cursor ([f88b6be](https://github.com/mintoriakamoto/rtk/commit/f88b6bec1323265cfced77c449bd795f2506cc90))
* **permissions:** project-first config lookup for Gemini/Cursor ([084fa84](https://github.com/mintoriakamoto/rtk/commit/084fa84e9a58387b5d77ca68db8731d361a89f2b))
* **permissions:** stop extra whitespace from evading deny rules ([3483786](https://github.com/mintoriakamoto/rtk/commit/348378602e97a93a4a39449c13cb00882bba44dc))
* **permissions:** stop extra whitespace from evading deny rules ([f6b9290](https://github.com/mintoriakamoto/rtk/commit/f6b92900603adf00ecd30d2119d63a322a471583))
* **php:** address phpstan review feedback (resolution, text fallback, path compaction) ([07c231e](https://github.com/mintoriakamoto/rtk/commit/07c231ee4cc31fa1df218a91ec7d8046144c1c7b))
* **php:** align pint/phpstan parsers with current tool schemas ([0b75581](https://github.com/mintoriakamoto/rtk/commit/0b75581f6b9a2df1a4066b01f0b1d6cf8dbbab37))
* **php:** anchor phpunit failure-heading detection to the "N) " format ([128d04f](https://github.com/mintoriakamoto/rtk/commit/128d04f7790990a20ee7609f77cc8baa105dc526))
* **php:** classify php subcommands in the PASSTHROUGH list ([4a37246](https://github.com/mintoriakamoto/rtk/commit/4a37246a051e6b4585a4a396e2581854a930f029))
* **php:** default pint applied_fixers when key is absent ([0cc15dc](https://github.com/mintoriakamoto/rtk/commit/0cc15dc4484d9bec5a11e770515f8c2d69378de5))
* **php:** detect phpstan analyse after global flags; avoid duplicate format ([7cc46b4](https://github.com/mintoriakamoto/rtk/commit/7cc46b46766e4b37256f385392ed0c6a4ea7bc85))
* **php:** drop bogus pest.php check in test-runner detection ([28366ce](https://github.com/mintoriakamoto/rtk/commit/28366ce17bd9f7fe898deee8b2a7ca8e3223c8de))
* **php:** rewrite ./vendor/bin/&lt;tool&gt; form for phpunit/pest/paratest/ecs/pint ([88e56ce](https://github.com/mintoriakamoto/rtk/commit/88e56cef85dbbaf74f9857ecfa634b9da6db57d9))
* **php:** route php_tool_command through resolved_command ([8eae6b7](https://github.com/mintoriakamoto/rtk/commit/8eae6b7334ccc43758f8870773c491ebc4e99f35))
* **php:** strip ANSI in phpunit filter and split errors from failures ([8825480](https://github.com/mintoriakamoto/rtk/commit/8825480b7af671cb7cbf87f8c902f79486d4eb95))
* **pipe:** anchor phpunit auto-detection to the leading banner ([50a8743](https://github.com/mintoriakamoto/rtk/commit/50a8743041081f7185ecd8e3ca48e432fb8ca5f4))
* **pipe:** apply the never-worse guard ([9d9ad7c](https://github.com/mintoriakamoto/rtk/commit/9d9ad7cb177a1da22c4395dc6716fdf5e640a6f3))
* **pkg:** rtk is Apache 2.0 and no MIT ([fa11c6c](https://github.com/mintoriakamoto/rtk/commit/fa11c6c3ebe55f36a0c09f15995333cda19a737a))
* **pkg:** rtk is Apache 2.0 and no MIT ([1875945](https://github.com/mintoriakamoto/rtk/commit/1875945bf32b3cc8f7f4c8da81427e17ded74c7f))
* prevent crashes when output is piped ([acfd6c5](https://github.com/mintoriakamoto/rtk/commit/acfd6c5889b00255064b13b83a39808cc57d2605))
* **provider:** sanatize more chars when encoding claude code project pathes ([653a209](https://github.com/mintoriakamoto/rtk/commit/653a209485601c4f0ba22ca44cff3d11cb38fc5c))
* **provider:** sanatize more chars when encoding claude code project pathes ([5989ac9](https://github.com/mintoriakamoto/rtk/commit/5989ac91b008dece0d36b62c2deb169a90d5063d)), closes [#2150](https://github.com/mintoriakamoto/rtk/issues/2150)
* **pulumi:** keep Owner and version in pulumi-stack filter ([5cfe4d5](https://github.com/mintoriakamoto/rtk/commit/5cfe4d5f87cecc7996cdbd837b7bf3dab2518a4e))
* **pulumi:** keep stack identity in pulumi-stack filter ([1f6e36b](https://github.com/mintoriakamoto/rtk/commit/1f6e36b27ef4fd2237465c97a8e73fbe4e990f61))
* **pytest:** strip ANSI so colored runs don't dump raw output ([aba7643](https://github.com/mintoriakamoto/rtk/commit/aba7643189cd19ed939f4f37b1e0159589a6f151))
* **python:** stop reporting a failed tool run as clean ([86b34df](https://github.com/mintoriakamoto/rtk/commit/86b34df8e3d4eb48b03b898a58757fccff43592b))
* **read:** make guard baseline faithful to cat/cat -n output ([9a2ad90](https://github.com/mintoriakamoto/rtk/commit/9a2ad90360b39ba8786f6056188ee9a939a9db28))
* remove absolute Claude hook commands ([b0c0b20](https://github.com/mintoriakamoto/rtk/commit/b0c0b204d841193ea83f27e1c194162195d6ab93))
* remove remaining noise and rework comments ([3c356b3](https://github.com/mintoriakamoto/rtk/commit/3c356b32416be0815bee9e4364c20c4efa15d829))
* rewrite only safe final pipeline commands ([590445e](https://github.com/mintoriakamoto/rtk/commit/590445e7598a37c60b310d8f157dd0b7af7a3421))
* **rewrite:** bail on cross-line [[ ]], share quote-state walker ([b09da2d](https://github.com/mintoriakamoto/rtk/commit/b09da2d0f804cdb61e9f7f1a452803d028212408))
* **rewrite:** bail on swallowed newlines and cross-line arithmetic ([ac5febe](https://github.com/mintoriakamoto/rtk/commit/ac5febe3bb1c57195d3bdbe73d029c6aad34a64d))
* **rewrite:** harden line-independence checks from second review round ([93aab9a](https://github.com/mintoriakamoto/rtk/commit/93aab9a29c940c7adcbf98b25f28d9b60020302d))
* **rewrite:** keep pipeline-final wc commands raw ([1c5a23c](https://github.com/mintoriakamoto/rtk/commit/1c5a23c64a5912150989626be7e4c3a468848313))
* **rewrite:** keep rewriting quoted multi-line strings as one command ([3c8892f](https://github.com/mintoriakamoto/rtk/commit/3c8892f5c08d23d857643ff2c8dc4ee2dfeee549))
* **rewrite:** narrow multiline passthrough bails from [#3188](https://github.com/mintoriakamoto/rtk/issues/3188) review ([d171449](https://github.com/mintoriakamoto/rtk/commit/d1714494914b003d6456c1dae0afa579d2bef4c4))
* **ruff:** bound output when user sets --output-format ([fa82e18](https://github.com/mintoriakamoto/rtk/commit/fa82e18d56d55ddac6d1a18621e492786ed02016))
* **ruff:** honour a user-supplied --output-format ([44982e0](https://github.com/mintoriakamoto/rtk/commit/44982e070bc4e1668eb66abf1b05caacb0ab14df))
* **run:** propagate signal exit code instead of unwrap_or(1) ([113ae11](https://github.com/mintoriakamoto/rtk/commit/113ae1188aee7611754a1ac664eec9a138c14257))
* **run:** propagate signal exit code instead of unwrap_or(1) ([a58de9d](https://github.com/mintoriakamoto/rtk/commit/a58de9d60aa3585491b509eead3ace3039722518)), closes [#2680](https://github.com/mintoriakamoto/rtk/issues/2680)
* satisfy clippy 1.97 unnecessary_sort_by in log_cmd ([9c9ff45](https://github.com/mintoriakamoto/rtk/commit/9c9ff458bf3335877cdbb38d1835b1f92ac3556e))
* **sbt:** add Debug derive to SbtCommands to satisfy Commands enum requirement ([1640eaa](https://github.com/mintoriakamoto/rtk/commit/1640eaad0dfb1d2afddcffb00cba970eb9094374))
* **sbt:** add munit summary support and fix misleading parse error label ([3586e8b](https://github.com/mintoriakamoto/rtk/commit/3586e8b3bcf43f162e8e5980bfefb536d50cb83f))
* **sbt:** address review feedback on output guard, routing, and dead code ([ef38103](https://github.com/mintoriakamoto/rtk/commit/ef38103fed2480975b3d729e094628548d83130e))
* **sbt:** compute tee label before args_display move ([3dff2aa](https://github.com/mintoriakamoto/rtk/commit/3dff2aa0f7d476187db998e00b4a7fc3e5ab1a01))
* **sbt:** drop sbt 0.13 legacy task names ([f6a4c41](https://github.com/mintoriakamoto/rtk/commit/f6a4c416927663a35eca08f94298300c85154a75))
* **sbt:** filter testOnly/testQuick like sbt test ([194f392](https://github.com/mintoriakamoto/rtk/commit/194f39253992fbc8f8375159c4694e5936e04a1c))
* **sbt:** filter testOnly/testQuick like sbt test ([c02f4d0](https://github.com/mintoriakamoto/rtk/commit/c02f4d00f5213b83e189254b9ffe065fe1b0cf9d))
* **sbt:** separate tee label for selective test tasks ([973b3b6](https://github.com/mintoriakamoto/rtk/commit/973b3b6286049973945f82316ec684e13d205aae))
* **search:** display nb line only if requested ([a8b9eb3](https://github.com/mintoriakamoto/rtk/commit/a8b9eb39011cd64aa715861c2d11820ee55fb221))
* **search:** make rtk grep line numbers faithful to plain grep ([608e574](https://github.com/mintoriakamoto/rtk/commit/608e5741f395ce10a8f31a2422cc07d25d1579a9))
* **search:** make tee-recovery blocks respect show_file/show_line ([792f432](https://github.com/mintoriakamoto/rtk/commit/792f43276e568131782b62b0e8cc04afdfa888bd))
* **search:** stream piped grep and rg output ([66b95cb](https://github.com/mintoriakamoto/rtk/commit/66b95cb94abb8c97d35997fb1acd2a891b336e44))
* **security:** address followup review comments on private-file hardening ([e0ffd40](https://github.com/mintoriakamoto/rtk/commit/e0ffd40ef7c450489aca4a50c0ab1358e4375691))
* **security:** address followup review comments on private-file hardening ([2ba02f4](https://github.com/mintoriakamoto/rtk/commit/2ba02f4b6a4cdadd8ca887b32f81e526a1c53757))
* **security:** create data files owner-only instead of chmod after write ([a1bbcaf](https://github.com/mintoriakamoto/rtk/commit/a1bbcaf3eb7731b1025d541a961fcba4f06d078c))
* **security:** harden installer checksum, filter-trust, meta-command ([769b6ce](https://github.com/mintoriakamoto/rtk/commit/769b6ce5a44ec696bf40d845a7fea35cdb5f7699))
* **security:** harden installer checksum, filter-trust, meta-command fallthrough ([9cc4937](https://github.com/mintoriakamoto/rtk/commit/9cc4937dac3ba9aa27147699afe66a2842e7bffc))
* **security:** harden meta command list check ([069a089](https://github.com/mintoriakamoto/rtk/commit/069a089c409193115b83fd27438d1bd73bf876b0))
* **security:** place nosemgrep directive adjacent to the flagged line ([fe174e0](https://github.com/mintoriakamoto/rtk/commit/fe174e063291c43c18fadcd3a04f53e444d67fa3))
* **security:** port permission hardening from master + Copilot CLI adaptation ([e1cd274](https://github.com/mintoriakamoto/rtk/commit/e1cd274ab9f3d473b694547e511e5baf1eae9734))
* **security:** store history db, tee logs and audit log owner-only ([57b7900](https://github.com/mintoriakamoto/rtk/commit/57b79008d492bf6e070f7a56e3e25a699c4227a6))
* **security:** store history db, tee logs and audit log owner-only ([9cf7a6d](https://github.com/mintoriakamoto/rtk/commit/9cf7a6da27a99d65ed3f96a6978ef06abeb16108))
* **security:** tighten data dirs that already exist ([18925c2](https://github.com/mintoriakamoto/rtk/commit/18925c28346e4f76396ba3bb2fccdda96b14e3ec))
* semgrep markers on test-fixture sensitive paths ([66d66b1](https://github.com/mintoriakamoto/rtk/commit/66d66b1fe6293e0f93d9797ae04e72b7ca40eaa0))
* **tee:** normalize home-relative shell paths ([5de188b](https://github.com/mintoriakamoto/rtk/commit/5de188bed22368a853fbdb227fdeec8eac3a1493))
* **tee:** quote paths containing backslashes ([991ed97](https://github.com/mintoriakamoto/rtk/commit/991ed971badc8ade9b4d95869b5bb598f871fbf3))
* **tee:** quote recovery hint paths with spaces ([8a24ce2](https://github.com/mintoriakamoto/rtk/commit/8a24ce2e2828117f69ffc31134ed12f36d33fac4))
* **tee:** quote recovery hint paths with spaces ([b1f35f6](https://github.com/mintoriakamoto/rtk/commit/b1f35f6b68883c55b917dcb56bc26f2bd4d8a241))
* **test:** adapt new rewrite_command signature in php-tooling tests ([c37eed9](https://github.com/mintoriakamoto/rtk/commit/c37eed962850af470de5c1bc0a69f26f8ea92ef9))
* **tests:** resync & list oc as passthrough for test ([444f1c0](https://github.com/mintoriakamoto/rtk/commit/444f1c09082f8a9a843499980f89b8c0682ddfef))
* **tests:** use rewrite_command_no_prefixes in line-continuation tests ([0ec99de](https://github.com/mintoriakamoto/rtk/commit/0ec99de8f4ef102c10a827b57636278080e2f3cf))
* tokenize |& as a single pipe operator ([ee149ee](https://github.com/mintoriakamoto/rtk/commit/ee149ee34a9f1cd82206b1c5f868a6884040d93c))
* **trust:** label detected filters as project- or global-scoped ([a9c33e2](https://github.com/mintoriakamoto/rtk/commit/a9c33e298768b0f33f401f71ca78f4df272fd936))
* **trust:** skip untrusted filters silently on the command path ([9d3b678](https://github.com/mintoriakamoto/rtk/commit/9d3b6782420b8ea93267eca91321235f60253fc0))
* **trust:** surface parse errors, skip already-trusted files, fail loudly when non-interactive ([2d487cb](https://github.com/mintoriakamoto/rtk/commit/2d487cb9477a02e3bebd0ea7b77d7826c724442a))
* **uv:** make tee recovery hints resolve to the data they promise ([bf14bf5](https://github.com/mintoriakamoto/rtk/commit/bf14bf54f085c1f80510a05150e121cc0c72ab46))
* **uv:** pass guard_raw arg to print_with_hint after signature change ([7e42d92](https://github.com/mintoriakamoto/rtk/commit/7e42d929e44d7c4fbd412de5dd4e5356613deba5))
* **uv:** preserve program output and restore inner-command filtering ([dfd1810](https://github.com/mintoriakamoto/rtk/commit/dfd1810dc9d260b8a62931392368a34606301fc0))
* **uv:** preserve program stdout and restore inner-command filtering ([8dd4aac](https://github.com/mintoriakamoto/rtk/commit/8dd4aacd6d917245c6a3fa2e350dab4309498079))
* **uv:** remove uv run from transparent prefixes to fix rewrite conflicts ([8cdc861](https://github.com/mintoriakamoto/rtk/commit/8cdc861ede47b3871191265b90e12edc02188a31))
* **uv:** remove uv run from transparent prefixes to fix rewrite conflicts ([96f9422](https://github.com/mintoriakamoto/rtk/commit/96f94222cbae9c9c9de5e05959388356026db5b6))
* **vibe:** address PR review — exit code contract, tests, telemetry, docs ([1847b07](https://github.com/mintoriakamoto/rtk/commit/1847b07f7a87fecba7fe0e39ade3d360c897dd66))
* **vitest:** add passthrough recovery hint ([f9469d1](https://github.com/mintoriakamoto/rtk/commit/f9469d12cfb48a6dda2b8c0578a7d5696804ae5f))
* **vitest:** preserve explicit reporters ([e3f60e9](https://github.com/mintoriakamoto/rtk/commit/e3f60e982261cd4a488a9f4593c40b13738f5f35))
* **vitest:** preserve explicit reporters ([e9b82fc](https://github.com/mintoriakamoto/rtk/commit/e9b82fc2bbd8100cbc200ae3dba6de49a05bcb26))
* wget bare -O means stdout, harden smoke network gate, CI/deps hygiene ([63107b2](https://github.com/mintoriakamoto/rtk/commit/63107b2856e4f1f6b85890760cc21c95e1759857))


### Performance Improvements

* **hook:** match TOML filters with a match-only RegexSet ([34c0bcf](https://github.com/mintoriakamoto/rtk/commit/34c0bcf2da7b585aa9a2fa619d23764b720c453b))
* **php:** cache composer_bin_dirs to avoid per-segment file reads ([5d2928c](https://github.com/mintoriakamoto/rtk/commit/5d2928c64e14b96e91a80761136aeb3e27fe5480))
* **php:** resolve cwd once in pint output instead of per file ([b5c3f7f](https://github.com/mintoriakamoto/rtk/commit/b5c3f7fac56a3f273c3a6517fb920e5970f7c545))
* trim binary deps, kill hot-path allocations and per-call regex compiles ([bf959d9](https://github.com/mintoriakamoto/rtk/commit/bf959d9ee1d589ee0ae6656a0768a719ce2749bc))
* trim binary deps, kill hot-path allocations and per-call regex compiles ([d559146](https://github.com/mintoriakamoto/rtk/commit/d559146165d3c063353c4a3a5e742e33a1d06207))


### Reverts

* **cargo:** drop --message-format=json install routing ([751bf3e](https://github.com/mintoriakamoto/rtk/commit/751bf3e76077db278a54a0bfa5177162478fe8b8))
